...
def get_parser():
    ...
    parser.add_argument("--config",
                        type=str,
                        default="config/diffusion_pose.yaml",
...
if __name__ == "__main__":
    ...
    if cfg.model_arch == "diffusion":
        from model.diffusion_pose import DIFFUSION, SupervisedLoss
        model = DIFFUSION()
    else:
    ...
    # loss_real = Self_SupervisedLoss(cfg).cuda()
    loss  = {
        "syn": loss_syn,
        "real": loss_real,
    }
    ...
    # dataloader
    data_mode = cfg.get("data_mode", "Camera") #!!!!!!!!!!!!!!!!!
